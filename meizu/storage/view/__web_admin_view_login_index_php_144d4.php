...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    ...
    <div class="container aside-xxl">
        ...
        <a class="navbar-brand block" href="<?php echo __ROOT__?>">Dream商城后台管理</a>
        ...
        <section class="panel panel-default bg-white m-t-lg">
            ...
            <form method="post" action="" class="panel-body wrapper-lg">
                ...
                <div class="form-group">
                    ...
                    <input required type="text" class="form-control input-lg" name="adminaccount">
                ...
                <div class="form-group">
                    ...
                    <input required type="password" id="inputPassword" class="form-control input-lg" name="adminpwd">
            ...
            <input type='hidden' name='__TOKEN__' value='6ae23d66ea6b935ac22bfc6a2149c150'/></form>
