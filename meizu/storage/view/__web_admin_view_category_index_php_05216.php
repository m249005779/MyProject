...
<div class="container-fluid admin_menu">
    ...
    <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
        ...
        <li class="active">
            <a href="<?php echo u('store')?>">添加分类</a>
        </li>
    </ol>
    <ul class="nav nav-tabs" role="tablist">
        <li class="active"><a href="javascript:;">分类管理</a></li>
        <li><a href="<?php echo u('store')?>">添加分类</a></li>
    </ul>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tr >
                        <td style="text-align: center" width="150"><?php echo $v['cid']?></td>
    ...
    <input type='hidden' name='__TOKEN__' value='4c5ff04cddb208fb4d4834b39cc0e9ef'/></form>
