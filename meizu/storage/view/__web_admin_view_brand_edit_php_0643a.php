        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="bname" value="<?php echo $oldData['bname']?>" required class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">品牌排序</label>
                    <div class="col-sm-9">
                        <input type="number" name="sort" value="<?php echo $oldData['sort']?>" required class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <input type="radio" value="1" name="ishot" <?php if($oldData['ishot'] == 1){?>
                checked
               <?php }?> ><i></i> 热门
                        </label>
                        <label class="radio-inline">
                            <input type="radio" value="2" name="ishot" <?php if($oldData['ishot'] == 2){?>
                checked
               <?php }?> ><i></i> 不热门
                        </label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input type="text" class="form-control" value="<?php echo $oldData['logo']?>" name="logo" readonly="" >
            ...
            <input type="hidden" name="bid" value="<?php echo q('get.bid')?>">
        </div>
        <button class="btn btn-primary" type="submit">确定</button>
    <input type='hidden' name='__TOKEN__' value='cd12dd6f3cb0427121b926623863f3ad'/></form>
