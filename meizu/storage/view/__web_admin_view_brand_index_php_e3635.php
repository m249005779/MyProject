...
<div class="container-fluid admin_menu">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li><a href="<?php echo u('store')?>">添加品牌</a></li>
    </ul>
            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tr style="text-align: center">
                        ...
                        <td>
                            <img width="150" height="50" src="<?php echo $v['logo']?>" alt="">
                        </td>
                        <td>
                            <?php if($v['ishot']==1){?>
                热门<?php }else{?>不热门
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="javascript:;" onclick="del(<?php echo $v['bid']?>)">删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
    ...
    <input type='hidden' name='__TOKEN__' value='947a3af2d780d2c0475af4708e8dc833'/></form>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href = "<?php echo u('del')?>" + '&bid=' + bid;
                }
            }
        });
        //显示模态框
