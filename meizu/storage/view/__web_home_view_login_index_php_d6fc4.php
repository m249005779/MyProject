...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo __ROOT__?>/resource/home/css/log.css"/>
...
<header>
    <div class="ucSimpleHeader">
        ...
        <div class="trigger">
            ...
            <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
            <a href="<?php echo u('register')?>" class="linkAGray" id="toRegister">注册</a>
        </div>
        <div class="middle">
            ...
            <input type='hidden' name='__TOKEN__' value='6b719a7516eeab28fcc59af157f9036a'/></form>
        </div>
    </div>
</header>
...
<script>
    function login()
    {
        ...
        var url = "<?php echo $_SESSION['home']['userurl']?>";
