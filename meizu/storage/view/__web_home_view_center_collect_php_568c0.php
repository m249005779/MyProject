...
<head>
    ...
    <link rel="stylesheet" href="<?php echo __ROOT__?>/resource/home/css/me.css" />
    ...
    <script src="<?php echo __ROOT__?>/resource/home/js/me.js"></script>
</head>
<body>
<header>
    <div class="top">
...
<!--            <a href="">我的商城 > </a>-->
            <a class="active" href="<?php echo u('index')?>">我的订单</a>
        </div>
        <div class="main">
            <div class="left-nav">
                <div class="nav-main">
                    ...
                    <a href="<?php echo u('index')?>">我的订单</a>
                    <a class="type-title" href="javascript:;">
                        <i class="icon-user"></i>
                        个人中心
                    </a>
                    ...
                    <div id="table-list" class="type-cotain">
                        <div class="ui-load-content">
                            <div class="clearfix">
                                ...
                                <div class="item">
                                    <i gid="<?php echo $v['gid']?>" id="" class="icon-trash trash"></i>
                                    <a href="">
                                        <img src="<?php echo $v['pic']?>" alt="">
                                    </a>
                                    <a target="_blank" href="">
                                        <h3><?php echo $v['gname']?></h3>
                                    </a>
                                </div>
                                <?php }?>
                            </div>
...
//            $.post("u<?php echo u('ajaxCollect')?>",{gid:gid},function (res) {
//                if(res.valid){
