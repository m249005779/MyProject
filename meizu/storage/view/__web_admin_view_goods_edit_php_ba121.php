...
<div class="container-fluid admin_menu">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="gname" value="<?php echo $oldData['gname']?>" class="form-control" placeholder="请填写商品名称">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="js-example-basic-single form-control" name="cid">
                            ...
                            <?php foreach ((array)$cateData as $k=>$v){?>
                                <option <?php if($oldData['cid'] == $v['cid']){?>
                selected="selected"
               <?php }?> value="<?php echo $v['cid']?>" tid="<?php echo $v['tid']?>" ><?php echo $v['_cname']?></option>
                            <?php }?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-sm-9">
                        <select class="js-example-basic-single form-control" name="bid">
                            ...
                            <?php foreach ((array)$brandData as $k=>$v){?>
                                <option <?php if($v['bid'] == $oldData['bid']){?>
                selected="selected"
               <?php }?> value="<?php echo $v['bid']?>"><?php echo $v['bname']?></option>
                            <?php }?>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9" id="attr">
                        <table class="table table-striped">
                            <?php foreach ((array)$toData as $k=>$v){?>
                            <tr>
                                <td><?php echo $v['taname']?></td>
                                <td>
                                    <select name="attr[<?php echo $v['taid']?>]">
                                        <option value="0">请选择</option>
                                        <?php foreach ((array)$v['tavalue'] as $key=>$value){?>
                                        <option <?php if($v['gtvalue'] == $value){?>
                selected="selected"
               <?php }?> value="<?php echo $value?>"><?php echo $value?></option>
                                        <?php }?>
                                    </select>
                                </td>
                            </tr>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9" id="spec">
                        <table class="table table-striped">
                            <?php foreach ((array)$poData as $k=>$v){?>
                                <tr>
                                    <td><?php echo $v['taname']?></td>
                                    <td>
                                        <select name="spec[<?php echo $v['taid']?>][color][]">
                                            <option value="0">请选择</option>
                                            <?php foreach ((array)$v['tavalue'] as $key=>$value){?>
                                                <option <?php if($v['gtvalue'] == $value){?>
                selected="selected"
               <?php }?> value="<?php echo $value?>"><?php echo $value?></option>
                                    ...
                                    <td>附加价格</td>
                                    <td><input type="text" name="spec[<?php echo $v['taid']?>][added][]" value="<?php echo $v['added']?>"></td>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="gnumber" value="<?php echo $oldData['gnumber']?>" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">单位</label>
                    <div class="col-sm-9">
                        <input type="text" name="unit" value="<?php echo $oldData['unit']?>" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">市场价</label>
                    <div class="col-sm-9">
                        <input type="text" name="marketprice" value="<?php echo $oldData['marketprice']?>" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">商城价</label>
                    <div class="col-sm-9">
                        <input type="text" name="shopprice" value="<?php echo $oldData['shopprice']?>" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">总库存</label>
                    <div class="col-sm-9">
                        <input type="text" name="total" value="<?php echo $oldData['total']?>" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="input-group" id="box" style="margin-top:5px;">
                            <?php foreach ((array)$detailData['big'] as $k=>$v){?>
                                <div style="padding: 5px;position: relative;float: left">
                                    <li style="float: left;list-style: none;">
                                        <img src="<?php echo $v?>" alt="" width="150" class="img-responsive img-thumbnail">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="click" value="<?php echo $oldData['click']?>" class="form-control" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea id="intro" name="intro" style="height:300px;width:100%;"><?php echo $detailData['intro']?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">售后服务</label>
                    <div class="col-sm-9">
                        <textarea id="service" name="service" style="height:300px;width:100%;"><?php echo $detailData['service']?></textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <input type='hidden' name='__TOKEN__' value='7d7be8a9ca74b9a694971e88f322ac0a'/></form>
