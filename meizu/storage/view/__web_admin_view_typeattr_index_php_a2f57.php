...
<div class="container-fluid admin_menu">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li><a href="<?php echo u('store',['tid'=>q('get.tid')])?>">添加类型属性</a></li>
    </ul>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php foreach ((array)$res['data'] as $k=>$v){?>
                    <tr style="text-align: center">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo u('edit',['tid'=>q('get.tid'),'taid'=>$v['taid']])?>">编辑</a></li>
                                    <li class="divider"></li>
                                    <li><a href="javascript:;" onclick="del(<?php echo $v['taid']?>,<?php echo q('get.tid')?>)">删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
        ...
        var obj = util.modal({
            ...
            events:{
                confirm:function(){
                    ...
                    location.href = "<?php echo u('del')?>" + '&taid=' + taid + '&tid=' + tid;
                }
            }
        });
        //显示模态框
