...
<div class="container-fluid admin_menu">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li><a href="<?php echo u('store')?>">添加商品</a></li>
    </ul>
            ...
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <tr style="text-align: center">
                        ...
                        <td>市场价:<?php echo $v['marketprice']?>
                            <br>
                            商城价:<?php echo $v['shopprice']?>
                        </td>
                        <td>库存</td>
                        <td><?php echo $v['click']?></td>
                        <th><?php echo date('Y-m-d h:i:s',$v['time'])?></th>
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="javascript:;" onclick="del(<?php echo $v['gid']?>)">删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
    ...
    <input type='hidden' name='__TOKEN__' value='7b7d42996b8f286cd01a450ad75afcf6'/></form>
