...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo __ROOT__?>/resource/home/css/login.css"/>
...
<header>
    <div class="ucSimpleHeader">
        ...
        <div class="trigger">
            <a href="<?php echo u('index')?>" class="linkAGray">登录</a>
            <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
...
<!--                    <span class="grayTip">@flyme.cn</span>-->
                ...
                <div class="normalInput">
                    ...
                    <img src="<?php echo U('code')?>" class="getKey"/>
                </div>
                <button style="border: none" type="submit" href="" class="fullBtnBlue">注册</button>
                <div style="text-align: center" id="msg"></div>
            <input type='hidden' name='__TOKEN__' value='43ee853e9c01bc4a9da535c210c7399f'/></form>
        </div>
    </div>
</header>
<!--<footer>-->
...
<!--                    <a href="">关于魅族</a>-->
<!--                    <img src="<?php echo __ROOT__?>/resource/images/order/z2.gif"/>-->
<!--                    <a href="">关于魅族</a>-->
<!--                    <img src="<?php echo __ROOT__?>/resource/images/order/z2.gif"/>-->
<!--                    <a href="">关于魅族</a>-->
<!--                    <img src="<?php echo __ROOT__?>/resource/images/order/z2.gif"/>-->
...
<script>
    function register()
    {
        ...
        $.post("<?php echo u('login.register')?>",data,function (res) {
            if (res.valid){
                //登陆成功
