...
<block name="content">
    ...
    <form class="form-horizontal" id="form" onsubmit="return edit()" action="" method="post">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="author" value="{{$oldData['title']}}" class="form-control" placeholder="文章作者">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <foreach from="$tagData" key="$k" value="$v">
                            <label class="checkbox-inline">
                                <input type="checkbox" <if value="in_array($v['tid'],$arcTag)">checked</if> name="tag_tid[]" value="{{$v['tid']}}"> {{$v['tname']}}
                            </label>
                        </foreach>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input type="text" class="form-control" name="thumb" value="{{$oldData['thumb']}}" readonly="" >
                        ...
                        <div class="input-group" style="margin-top:5px;">
                            <img src=value="{{$oldData['thumb']}}" class="img-responsive img-thumbnail haibao"
                                 width="150">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="keywords"  class="form-control" placeholder="文章摘要">{{$oldData['keywords']}}</textarea>
                    </div>
                </div>
                <div class="form-group">
        ...
        <input type="hidden" name="aid" value="{{q('get.aid')}}">
