...
<div class="container-fluid admin_menu">
    ...
    <form class="form-horizontal" id="form" onsubmit="return edit()" action="" method="post">
                    ...
                    <div class="col-sm-9">
                        <?php foreach ((array)$tagData as $k=>$v){?>
                            <label class="checkbox-inline">
                                <input type="checkbox" <?php if(in_array($v['tid'],$arcTag)){?>
                checked
               <?php }?> name="tag_tid[]" value="<?php echo $v['tid']?>"> <?php echo $v['tname']?>
                            </label>
                        <?php }?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input type="text" class="form-control"value="<?php echo $oldData['thumb']?>"  name="thumb" readonly="" >
                        ...
                        <div class="input-group" style="margin-top:5px;">
                            <img src="<?php echo $oldData['thumb']?>" class="img-responsive img-thumbnail path"
                                 width="150">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="keywords"  class="form-control" placeholder=""><?php echo $oldData['keywords']?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">文章描述</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="des"  class="form-control" placeholder=""><?php echo $oldData['des']?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for=""  class="col-sm-2 control-label">文章内容</label>
                    <div class="col-sm-9">
                        <textarea id="container" style="height:300px;width:100%;" name="content"><?php echo $oldData['content']?></textarea>
                        <script>
        ...
        <input type="hidden" name="aid" value="<?php echo q('get.aid')?>">
        <button class="btn btn-primary" type="submit">确定</button>
    <input type='hidden' name='__TOKEN__' value='62905e453dc490df6a4d93813e51e3ba'/></form>
