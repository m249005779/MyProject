...
<div class="container-fluid admin_menu">
    ...
    <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
        <li>
            <a href="<?php echo u('admin/index/index')?>"><i class="fa fa-cogs"></i>
                文章管理</a>
        </li>
        <li class="active">
            <a href="">回收站管理</a>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="<?php echo u('reduction',['aid'=>$v['aid']])?>">还原</a></li>
                                        <li class="divider"></li>
                                        <li><a href="javascript:;" onclick="realDel(this,<?php echo $v['aid']?>)" title="<?php echo $v['title']?>">彻底删除</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
    ...
    <input type='hidden' name='__TOKEN__' value='9c56a8db3c83984afcda21bac7b4045f'/></form>
...
<script>
    function realDel(obj,aid)
    {
        ...
        var obj = util.modal({
            ...
            content:'<span>'+title+'&nbsp;这篇文章吗？'+'</span>',//内容
            ...
            events:{
                confirm:function(){
                    ...
                    $.post("<?php echo u('realDel')?>",{aid:aid},function(res){
                        if(res.valid){
