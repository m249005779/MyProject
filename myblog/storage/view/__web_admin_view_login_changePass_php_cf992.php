    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="" style="color: white;margin-left: -14px">孟令悦博客系统</a></h4>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="http://localhost/hdphp/index.php?s=admin/login/changePass">修改密码</a></li>
...
<div class="container-fluid admin_menu">
    ...
    <input type='hidden' name='__TOKEN__' value='9b7fd24bcef95f9c451ed50cc93e21d9'/></form>
