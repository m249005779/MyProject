...
<head>
    <meta charset="utf-8">
    <title>中国领跑残奥半程奖牌榜 泳坛健儿占半壁江山</title>
...
<article>
    ...
    <div class="l_box f_l">
        <div class="topnews">
            <h2 style="font-size: 25px;text-align: center"><?php echo $articleData['title']?></h2>
            <p class="autor"><a href="#">作者：<?php echo $articleData['author']?></a><span class="dtime f_l"><?php echo date('Y-m-d',$articleData['sendtime'])?></span></p>
            <div class="blogs">
                <p style="font-size: 16px"><?php echo $articleData['content']?></p>
                <p  class="autor">
						<span class="lm f_l">
							<?php foreach ((array)$articleData['tag'] as $key=>$value){?>
